...
//Recupere les donnees du capteur d'humidite et renvoit la derniere valeur
function soilSensor(){
  var valeur=0;
  ...
  axios.get("https://my.farm.bot/api/sensor_readings", { 'headers': { 'Authorization': APPLICATION_STATE.token } } ).then((res) => {
      var i = 1;
...
function WeatherDarkSky(){
  axios.get("https://api.darksky.net/forecast/83a42c27e8d21e20e138b4691e6aa8d3/42.3601,-71.0589").then((res) => {
    console.log(res);
  })
}
